            ...
            <Card 
                ...
                <View style={styles.cardRow}>
                    ...
                    onPress={() => props.favorite ? 
                            console.log('Already set ass a favorite') : props.markFavorite()}
                    />
                    <Icon
                    name='pencil'
                    type='font-awesome'
    ...
    const renderCommentItem = ({item}) => {
        return (
            <View style={{margin :10}}>
                <Text stye={{fontSize: 14}}>{item.text}</Text>
                <Rating 
                    ...
                    readOnly={true}
                />
                <Text stye={{fontSize: 12}}>{`-- ${item.author}, ${item.date}`}</Text>
            </View>
        )
    } 
        ...
        return(
            <ScrollView>
                ...
                >
                    ...
                    <Rating 
                        showRating startingValue={this.state.rating} imageSize='40' 
